---
title: "POLS 1600"
subtitle: "Prediction I / Linear Regression"
date: last-modified
...
- Introduce use of research design to make causal claims with observational data

  - [Differences-in-Differences]{.blue}

## Annoucements

- Tutorial 5 due on Monday 3-2. 

- Resuming labs on Friday - [link here](https://josephessig-source.github.io/pols1600_site/labs/05-lab.qmd)

- If any issues with group assignment, let me know after class.
...
#new.packages <- the_packages[!(the_packages %in% installed.packages()[,"Package"])]
# 
# # 3. If there are any missing packages, install them
...
fig_lm +
  ...
  annotate("text",
           # --- THE FIX ---
           # Pass the label as a string and set parse = TRUE.
           # Use '~' for spaces and '\"=\"' for subsequent equals signs.
           label = "hat(Y)[i] == beta[0] + beta[1] * Age ~ \"=\" ~ 62.81 - 0.20 * 47 ~ \"=\" ~ 53.27",
           parse = TRUE,
           # ----------------
           x = 55.5, y = 53.27526,
           col = "blue",
...
## Interpretations of Linear Regression{.smaller}
...
[Please download]{.blue} Friday's lab [here](https://josephessig-source.github.io/pols1600_site/labs/05-lab.qmd)
...
- [Please run this code before class on Friday]{.blue}
