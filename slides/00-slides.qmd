...
-   Upload output to Canvas by the following Monday by 11:59 pm
-   Grades:
    -   100% any upload
    -   0% no upload
...
-   On Friday, we will make sure everyone has [Downloaded and Installed R and R studio](https://pols1600.paultesta.org/labs/00-software-setup.html)
