...
- Prompt posted on website [here](https://josephessig-source.github.io/pols1600_site/assignments/a2.html)

- Uploaded to Canvas by [Sunday, March 8]{.blue}

- Let me know by Friday if you are having trouble getting all your group members on the same page, can extend. 
...
load(url("https://josephessig-source.github.io/pols1600_site/files/data/pres_df.rda"))
...
load(url("https://josephessig-source.github.io/pols1600_site/files/data/nes.rda"))
...
$$\text{m1: tc\_diff} = \beta_0 + \beta_1\text{interested}+\epsilon$$ 

$$\text{m2: tc\_diff} = \beta_0 + \beta_1\text{pol\_interest}+\epsilon$$ 

$$\text{m3: tc\_diff} = \beta_0 + \beta_1\text{pol\_interest\_f} +\epsilon$$ 

$$\text{m4: tc\_diff} = \beta_0 + \beta_1\text{interested} + \beta_2\text{age} +\epsilon$$ 

$$\text{m5: tc\_diff} = \beta_0 + \beta_1\text{interested} + \beta_2\text{age} + \beta_3\text{interested} \times \text{age}+\epsilon$$ 

$$\text{m6: tc\_diff} = \beta_0 + \beta_1\text{age} + \beta_2\text{income} +\epsilon$$

$$\text{m7: tc\_diff} = \beta_0 + \beta_1\text{age} + \beta_2\text{income} + \beta_4\text{age}\times \text{income}+\epsilon $$
...
```{r}
load(url("https://josephessig-source.github.io/pols1600_site/files/data/acs_df.rda"))
