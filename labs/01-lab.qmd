...
Today, we'll continue exploring the COVID-19 data for the U.S.
...
Now, we will load the packages for today. 
...
Now, we will run the code from last time that generates the Covid data. 
...
After class, on the course website and canvas, you'll find my "commented" solutions on today's lab.
...
Please upload the html file produced by your .Rmd file to [Canvas](https://canvas.brown.edu/courses/1102109/assignments/8102891)
