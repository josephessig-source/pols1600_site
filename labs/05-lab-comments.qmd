...
dim(covid_df) # Same number of rows as covid_us w/ 8 additional columns
```
...
Please take a few moments to complete the [class survey](https://brown.co1.qualtrics.com/jfe/form/SV_bDFDWRGcnpm09hk){target="_blank"} for this week.
