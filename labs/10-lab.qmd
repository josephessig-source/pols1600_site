---
title: "Lab 10 - Exploring data in the 2024 National Elections Study Continued"
...
2. Load the data from last week

3. Revisit and revise your research question and expectations 

4. Estimate models to explore your question 

5. Interpret the results of your model 

One of these 5 tasks will be randomly selected as the graded question for the lab.
...
- Translating research questions into empirical expectations (Q3)
  
- Estimating linear models (Q4)

- Interpreting the substantive and statistical significance of these models (Q5)
...
Please load the libraries you will use in your analysis. (Take a look at the previous lab if you don't know which packages you need). 
...
:::{.callout-note}
You'll need to **have saved** the data from last week's lab to the **same folder** where this lab has been saved. If you didn't save the lab data from last week, you can load a version of the recoded data here (but none of your recoding will be in this data):
