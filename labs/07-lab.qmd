...
author: "Your group members here"
...
- **What's the core finding?** The main results of their analyses are presented in ... They find ... 
...
In the code chunk below, please take a quick look at each dataset and answer the following about each dataset.  I'll get you started for `fips_codes`. You will do the same for `policy_data` and `cps`
...
- `cps`
  ...
  - **How many observations** 
  - **How many variables** 
  - **What variables describe whether someone voted and how old they are** 
