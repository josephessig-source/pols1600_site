...
It's available to you in multiple places like the [slides](https://josephessig-source.github.io/pols1600_site/slides/01-slides#/commented-code) and the comments to last week's lab. 
...
Recall, that we need `data`, `aesthetic` mappings and `geometries` to produce a figure. You can find the code from lab 1 in the commented solutions. 
