---
title: "Lab 09 - Exploring data in the 2024 National Elections Study"
...
In this lab, we'll explore data from the National Election Studies 2024 Pilot Study. You find an outcome of interest and a variable you think predicts interesting variation in that outcome. You'll figure out what recoding you need to do, do that recoding, and describe the data. 
...
2. Download and load data from the NES into R

3. Explore the codebook for the 2024 Pilot Study 

4. Get a high level overview of the data to figure out what recoding needs to be done 

5. Recode the data 

6. Describe the data 

7. Formulate a set of research questions 
...
- Unzip `anes_pilot_2024_dta_20240319.zip`. 
  ...
  - On a PC it asks you where you want to unzip the files. Please unzip them directly into your course folder.  
...
# df <- read_dta(url("https://josephessig-source.github.io/pols1600_site/files/data/anes_pilot_2024_20240319.dta"))
```
