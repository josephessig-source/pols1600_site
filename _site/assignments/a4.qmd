...
Additionally, I will assign points to each section as if it were your final paper to give you a sense of where to focus your efforts. This is not your actual grade for this assignment, but can be though of as a rough estimate of the grade you would receive on a section if you were to submit it, as is, for your final paper. Your grade for that section on the final paper may increase or decrease depending on the changes you make to your draft.

I have also posted a template for the final paper here: <a href="https://josephessig-source.github.io/pols1600_site/files/pols1600_paper_template.qmd" download="" >  download </a> and an  <a href="https://josephessig-source.github.io/pols1600_site/assignments/POLS1600_final_paper_example.html" download="" >  example of a final paper </a> from a previous version of POLS 1600.
...
- The final paper assignment has changed over time. There are things this paper does, which I do not ask you to do (e.g. explain the difference between simulation and asymptotic approaches to statistical inference). There are things I ask you to do (e.g. write a separate theory section that motivates your expectations) which this paper was not required to do.
