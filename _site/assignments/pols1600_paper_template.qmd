...
- What is the phenomenon you are studying? (Research Question/Outcome of Interest)

- Why should we care about this? (Context/Motivation/Importance)

Then it should turn to addressing:

- What are the factors scholars think explain this phenomenon? (Literature Review/Key predictors/Alternative explanations)
...
- Explain how your key concepts (outcome variable, key predictors, covariates/alternative explanations) are measured

- Describe the distributions of these data using a table and/or figure(s). 

- Interpret these distributions for your reader. What does a typical observation in the data look like. Are some data skewed. Are there big outliers?

Before you write anything in this section, you will want to adapt the code chunks below to:
